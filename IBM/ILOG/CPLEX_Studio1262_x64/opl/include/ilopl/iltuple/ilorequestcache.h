...
public:
	...
	IloTupleRequestUnaryCacheI(IloEnv env, IloAllocationStack* stack);
...
public:
	...
	IloNaryIntCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloInt** key, IloMultipleIntHashTable* h);
...
public:
	...
	IloSimplifiedNaryIntCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloInt** key, IloMultipleIntHashTable* h);
...
public:
	...
	IloNaryIntUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloInt** key, IloMultipleUnaryIntHashTable* h);
...
public:
	...
	IloSimplifiedNaryIntUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloInt** key, IloMultipleUnaryIntHashTable* h);
...
public:
	...
	IloNaryNumCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloNum** key, IloMultipleNumHashTable* h);
...
public:
	...
	IloSimplifiedNaryNumCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloNum** key, IloMultipleNumHashTable* h);
...
public:
	...
	IloNaryNumUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloNum** key, IloMultipleUnaryNumHashTable* h);
...
public:
	...
	IloSimplifiedNaryNumUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloNum** key, IloMultipleUnaryNumHashTable* h);
...
public:
	...
	IloNaryAnyCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloAny** key, IloMultipleAnyHashTable* h);
...
public:
	...
	IloSimplifiedNaryAnyCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloAny** key, IloMultipleAnyHashTable* h);
...
public:
	IloNaryAnyUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt keySize, IloAny** key, IloMultipleUnaryAnyHashTable* h);
...
private:
	...
	IloMultipleUnaryAnyHashTable* _hash;
public:
	IloSimplifiedNaryAnyUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloInt size, IloAny** key, IloMultipleUnaryAnyHashTable* h);
...
public:
	...
	IloNaryCellCacheI(IloEnv env, IloAllocationStack* stack, IloTupleRequestI* key, IloQueryDataTableHash* h);
...
public:
	...
	IloNaryCellUnaryCacheI(IloEnv env, IloAllocationStack* stack, IloTupleRequestI* key, IloQueryUnaryDataTableHash* h);
