...
public:
	...
	void buildIntCaches(IloAllocationStack*);
	void buildNumCaches(IloAllocationStack*);
	void buildAnyCaches(IloAllocationStack*);
	void buildCommonCaches(IloAllocationStack*);

	void buildCache(IloAllocationStack*);
private:
